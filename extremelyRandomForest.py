...
# construct the argument parser - classifier type as an input parameter - can construct either extra or regular
...
if __name__=='__main__':
    ...
    X, y = data[:, :-1], data[:, -1]
    # separating data into three classes based on labels
    ...
    X_train, X_test, y_train, y_test = train_test_split(X, y, train_size=0.25, random_state=5)
